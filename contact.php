        ...
        <main class="nk-pages">
            <div class="nk-preview">
                <div class="tab-content nk-preview-content">
                    <div class="tab-pane fade show active" id="contact-default-06">
                        <!-- Copy from here -->
                        <div class="section section-contact bg-white ov-h">
                            <div class="container">
                                <!-- Block @s -->
                                                ...
                                                <form class="nk-form-submit" action="form/contact.php" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-5 text-end">
                                                            <button type="submit" class="btn btn-primary btn-round btn-lg">SEND</button>
                                                        </div>
                                            ...
                                            <div class="nk-block-contact nk-block-contact-s1">
                                                <ul class="contact-list">
                                                    <li>
                                                        ...
                                                        <div class="contact-text" style="padding-top: 0px;">
                                                            <span>+233 53 783 5444 <br> +233 53 783 7873</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <em class="contact-icon fas fa-envelope"></em>
                                                        <div class="contact-text">
                                                            <span>willinstantbitx@gmail.com</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="nk-circle-animation nk-df-center accent-alt small"></div><!-- .circle-animation -->
                                            </div>
